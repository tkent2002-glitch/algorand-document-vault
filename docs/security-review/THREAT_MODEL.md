...
| T5 | Transaction changes between display, signature, submission, or persistence | Policy inspection, Pera signing boundary, signed-transaction submission, confirmation checks | TOCTOU, multi-account/session changes, recovery and timeout paths |
