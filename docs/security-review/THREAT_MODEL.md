...
| T7 | Backup password is guessed or ciphertext is modified | PBKDF2-SHA-256 (600,000 iterations for new backups; controlled 250,000 legacy restore), random 16-byte salt, AES-256-GCM, random 12-byte IV, minimum 12-character password | Offline guessing of weak user passwords, legacy work factor, platform performance, parameter agility |
